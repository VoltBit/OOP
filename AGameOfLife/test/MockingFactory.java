...
public class MockingFactory {
    ...
    public static Cell[][] makeBoardInputSet(String type){
        ...
        switch (type) {
            ...
            case "basic":
                ...
                mockBoard[2][3].setState(State.Alive);
                mockBoard[2][4].setState(State.Alive);
                mockBoard[3][3].setState(State.Alive);
                mockBoard[3][5].setState(State.Alive);
                mockBoard[4][1].setState(State.Alive);
                mockBoard[4][2].setState(State.Alive);
                mockBoard[5][0].setState(State.Alive);
                mockBoard[5][2].setState(State.Alive);
                mockBoard[6][1].setState(State.Alive);
                mockBoard[6][2].setState(State.Alive);
                mockBoard[7][3].setState(State.Alive);
                break;
            case "minimal":
                boardSize = 3;
                mockBoard = new Cell[boardSize][boardSize];
            ...
            case "blinker":
                ...
                mockBoard[1][2].setState(State.Alive);
                mockBoard[1][3].setState(State.Alive);
                mockBoard[1][4].setState(State.Alive);
                    break;
            case "empty":
                boardSize = 10;
    ...
    public static Cell[][] makeSolvedBoardInputSet(String type){
        ...
        switch (type) {
            case "blinker":
                mockBoard = makeBoardInputSet("blinker");
                break;
            case "basic":
                mockBoard = makeBoardInputSet("basic");
                mockBoard[3][5].setState(State.Dead);
                mockBoard[4][3].setState(State.Alive);
                mockBoard[5][2].setState(State.Dead);
                mockBoard[5][3].setState(State.Alive);
                mockBoard[6][3].setState(State.Alive);
                mockBoard[7][2].setState(State.Alive);
                mockBoard[7][3].setState(State.Dead);
                break;
        }
        return mockBoard;
    }
